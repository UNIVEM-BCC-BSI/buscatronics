            ...
            while True:
                ...
                while True:
                    ...
                    for game in games:
                        ...
                        self.game_items_casasbahia.update({'plataforma': f'{self.urls_plataforma[self.url_index]}'})
                        self.game_items_casasbahia.update({'midia': 1})
                        self.game_items_casasbahia.update({'link': link})
                        self.game_items_casasbahia.update({'loja': 'Casas Bahia'})
...
try:
    casasbahia = CasaBahia()
    casasbahia.CasasBahia_Scrapper()
    game_items_list_casasbahia = casasbahia.game_items_list_casasbahia

    for x in game_items_list_casasbahia:
        print(x)
except:
    pass
