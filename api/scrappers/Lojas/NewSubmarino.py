...
try:
    submarino = Submarino()
    submarino.Submarino_Scrapper()
    game_items_list_submarino = submarino.game_items_list_submarino

    for x in game_items_list_submarino:
        print(x)
except:
    pass
