                ...
                while True:
                    ...
                    for game in games:
                        try:
                            ...
                            self.game_items_americanas.update({'plataforma': self.urls_plataforma[self.url_index]})
                            ...
                            self.game_items_americanas.update({'loja': 'Americanas'})
...
try:
    ...
    americanas.Americanas_Scrapper()
    game_items_list_americanas = americanas.game_items_list_americanas

    for x in game_items_list_americanas:
        print(x)
except:
    pass
